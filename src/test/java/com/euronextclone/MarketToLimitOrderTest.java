...
public class MarketToLimitOrderTest {
    ...
    public void continuousPhaseLimitOrdersTest()
    {
        ...
        matchingUnit.newOrder(Order.OrderSide.Buy, "A", 10, new OrderPrice(OrderType.Limit, 15));
        matchingUnit.newOrder(Order.OrderSide.Buy, "B", 10, new OrderPrice(OrderType.Limit, 12));
        matchingUnit.newOrder(Order.OrderSide.Buy, "C", 10, new OrderPrice(OrderType.Limit, 10));
        matchingUnit.newOrder(Order.OrderSide.Sell, "D", 25, new OrderPrice(OrderType.MarketToLimit));
    ...
    {
        final MatchingUnit matchingUnit = new MatchingUnit();
        matchingUnit.newOrder(Order.OrderSide.Buy, "A", 10, new OrderPrice(OrderType.MarketOrder));
        matchingUnit.newOrder(Order.OrderSide.Buy, "B", 10, new OrderPrice(OrderType.Limit, 12));
        matchingUnit.newOrder(Order.OrderSide.Buy, "C", 10, new OrderPrice(OrderType.Limit, 9));
        matchingUnit.newOrder(Order.OrderSide.Sell, "D", 25, new OrderPrice(OrderType.MarketToLimit));
